...
\todo{In here discuss how scoring rules can be applied to each margin and simply added up.  This allows us to compare unreconciled and reconciled forecasts.  It has been done in Ben Taieb Taylor Hyndman and Jeon Panagiotelis Petropoulos}
