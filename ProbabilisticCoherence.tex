...
\todo{Discuss log score, energy (inc. non-Euclidean?) score and variogram score in general}
...
\todo{Summary: Log score should not be used.  Energy score - still trying to prove that reconciled dominates unreconciled, will show "half" proof if necessart. Variogram score - it might be possible to show reconciled dominate unreconciled, I will have a look.}
