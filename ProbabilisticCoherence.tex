...
Points to discuss
\begin{itemize}
	\item Optimal reconciliation likely to depend on
	\begin{itemize}
		\item Properties of base probabilstic forecast
		\item Scoring rule
	\end{itemize}
    \item Case where no parametric form available
    \item Cases where $g$ and maybe even $s$ are non linear
\end{itemize}
