...
text(3.5,1.75,expression(bold(S)),pos=4, cex = 2.5)
...
text(1,4,expression(bold(R)),pos=3, cex = 2.5)
...
text(1.5,3,expression(hat(bold(y))),pos = 3,offset = 1.5, cex = 2.5)

points(0.6,0.3,pch=20,cex=2,col='black')
text(0.6,0.3,expression(bold(y)),pos = 1,offset = 1, font = 4, cex = 2.5)
...
points(0.6,0.3,pch=20,cex=2,col='black')
text(0.6,0.3,expression(bold(y)),pos = 1,offset = 1, cex = 2.5)
