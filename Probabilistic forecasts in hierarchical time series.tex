...
\bm{f_B}(\tilde{\bm{b}}_{t+h},\tilde{\bm{t}}_{t+h})=\hat{\bm{f}}(\bm{S}\tilde{\bm{b}}_{t+h}+\bm{R}\tilde{\bm{t}}_{t+h}) \quad det(\begin{array}{ccc}\bm{S} & \vdots& \bm{R}\end{array}),
\end{flalign}
\noindent
...
\begin{flalign}
\tilde{\bm{f}}(\tilde{\bm{b}}_{t+h})=\int_{lim(\tilde{\bm{t}}_{t+h})}\hat{\bm{f}}(\bm{S}\tilde{\bm{b}}_{t+h}+\bm{R}\tilde{\bm{t}}_{t+h}) \quad det(\begin{array}{ccc}\bm{S} & \vdots& \bm{R}\end{array})\quad d\tilde{\bm{t}}_{t+h}.
\end{flalign}
