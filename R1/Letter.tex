...
\begin{enumerate}
	\item We introduce a modification of MinT that can be used with a user defined loss function.  We demonstrate in the empirical example that...
	\item We have greatly expanded the empirical study including more measures of forecast accuracy (including those specifically measuring bias), a Nemenyi evaluation to highlight where differences in forecast accuracy are significant.
