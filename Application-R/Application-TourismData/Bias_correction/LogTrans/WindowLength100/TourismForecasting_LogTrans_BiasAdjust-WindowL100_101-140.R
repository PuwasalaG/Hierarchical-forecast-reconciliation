...
for (j in 101:140) {#C=140
  ...
  targ_bias <- diag(diag(var(Residuals_Bias[[1]])),n,n)
  ...
  Inv_WLS_bias <- diag(1/diag(var(Residuals_Bias[[1]])), n, n)
  ...
  targ_unbiased_M1 <- diag(diag(var(Residuals_Unbiased_M1)),n,n)
  ...
  Inv_WLS_unbiased_M1 <- diag(1/diag(var(Residuals_Unbiased_M1)), n, n)
  ...
  targ_unbiased_M2 <- diag(diag(var(Residuals_Unbiased_M2[[1]])),n,n)
  ...
  Inv_WLS_unbiased_M2 <- diag(1/diag(var(Residuals_Unbiased_M2[[1]])), n, n)
...
write.csv(x=DF, file = "Results/DF_LogTrans_WL100_101-140.csv")
save.image("Results/TourismData_LogTransBiasAdj_WL100_101-140.RData")
