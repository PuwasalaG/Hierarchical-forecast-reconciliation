...
#This analysis takes a rolling window approach and we use window length as 100
...
write.csv(x=DF, file = "Results/DF_BoxCoxTrans_WL100_101-140.csv")
save.image("Results/TourismData_BoxCoxTransBiasAdjust_WL100_101-140.RData")
