...
write.csv(x=DF, file = "Results/DF_BoxCoxTrans_26-50.csv")
save.image("Results/TourismData_BoxCoxTransBiasCorrection_26-50.RData")
...
DF %>% 
  filter(`F-method` == "Unbiased_M1", `R-method` == "MinT(Shrink)") %>% 
