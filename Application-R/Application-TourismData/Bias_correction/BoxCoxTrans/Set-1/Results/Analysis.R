...
DF_BoxCoxTrans_1_50 <- read.csv("DF_BoxCoxTrans_set1_1-50.csv")[,-1]
DF_BoxCoxTrans_51_100 <- read.csv("DF_BoxCoxTrans_set1_51-100.csv")[,-1]
DF_BoxCoxTrans_101_140 <- read.csv("DF_BoxCoxTrans_set1_101-140.csv")[,-1]

rbind(DF_BoxCoxTrans_1_50, DF_BoxCoxTrans_51_100, DF_BoxCoxTrans_101_140) %>% 
  as.data.frame() -> DF_BoxCoxTrans
write.csv(x=DF_BoxCoxTrans, file = "DF_BoxCoxTrans_set1.csv")
