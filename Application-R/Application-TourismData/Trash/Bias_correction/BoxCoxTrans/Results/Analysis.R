...
DF_BoxCoxTrans_1_50 <- read.csv("DF_BoxCoxTrans_1-50.csv")[,-1]
DF_BoxCoxTrans_51_100 <- read.csv("DF_BoxCoxTrans_51-100.csv")[,-1]
DF_BoxCoxTrans_101_140 <- read.csv("DF_BoxCoxTrans_101-140.csv")[,-1]
